...
while tt <= 2458845:
	...
	w_sun = (-437.06265902*3600 + 6190.04759991 * t + 1.64480000 * t**2 -0.00006400 * t**3 - -0.00001204 * t**4)*m.pi/(180*3600)
	#формула 5.16
	...
	for j in range(0, len(coeff_y)):
		arg_y = lambda_moon*coeff_x[j][3] + lambda_sun*coeff_x[j][4] + Om*coeff_x[j][5] + w_moon*coeff_x[j][6] + w_sun*coeff_x[j][7]
